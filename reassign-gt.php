...
<?php
  ...
  $form = ActiveForm::begin(['id' =>'assign-gt','action' => ['assign-gt'],'options' => ['','data-pjax' => true,'class' => 'form-horizontal form-material','enableAjaxValidation' => false,'enableClientValidation'=>true]]);
